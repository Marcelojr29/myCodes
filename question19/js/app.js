const calcular_resultados = () => {
    ...
    let a = Number(document.getElementById('valor_a').value);
    let b = Number(document.getElementById('valor_b').value);
    let c = Number(document.getElementById('valor_c').value);
